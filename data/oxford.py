...
class OxfordDataset(Dataset):
    def __init__(self,dataset_path,query_filename,transform=None,set_transform=None,v_size=0.01):
        super().__init__()
...
class TrainSetTransform:
    def __init__(self, aug_mode):
        ...
        self.aug_mode = aug_mode
        self.transform = None
        t = [RandomRotation(max_theta=180, max_theta2=10, axis=np.array([0, 0, 1])),
